...
<body>
  <div id="main">
    <header>
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="index.html">photo<span class="logo_colour">_blurred</span></a></h1>
    ...
    <footer>
      <p>Copyright &copy; photo_blurred. All Rights Reserved. | <a href="http://www.css3templates.co.uk">design from css3templates.co.uk</a></p>
    </footer>
  </div>
